...
EXPERIMENT_PATH=${HOME}"/scratch/sc_experiments/sc_800ep_lincls"
PRETRAINED_PATH=${HOME}"/scratch/sc_experiments/sc_800ep_train/model_800.pth.tar"
mkdir -p $EXPERIMENT_PATH

srun --output=${EXPERIMENT_PATH}/%j.out --error=${EXPERIMENT_PATH}/%j.err --label python -u ./src/lincls_eval.py \
-j 32 \
-b 1024 \
--print-freq 16 \
--epochs 100 \
