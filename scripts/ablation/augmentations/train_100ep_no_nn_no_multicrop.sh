...
#SBATCH --job-name=sc_100ep_train_no_nn_no_multicrop
#SBATCH --time=6:00:00
#SBATCH --requeue
#SBATCH --mem=64G
...
EXPERIMENT_PATH=${HOME}"/scratch/sc_experiments/sc_100ep_train_no_nn_no_multicrop"
