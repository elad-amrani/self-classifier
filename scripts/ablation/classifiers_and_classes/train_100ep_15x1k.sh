...
#SBATCH --job-name=sc_100ep_train_15x1k
#SBATCH --time=6:00:00
#SBATCH --requeue
#SBATCH --mem=64G
...
EXPERIMENT_PATH=${HOME}"/scratch/sc_experiments/sc_100ep_train_15x1k"
...
--cos \
--wd 1e-6 \
--cls-size 1000 1000 1000 1000 1000 1000 1000 1000 1000 1000 1000 1000 1000 1000 1000 \
--num-cls 15 \
--queue-len 262144 \
--dim 128 \
--hidden-dim 4096 \
