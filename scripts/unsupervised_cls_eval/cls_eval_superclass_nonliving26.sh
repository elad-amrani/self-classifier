...
#SBATCH --job-name=sc_800ep_cls_eval_superclass_nonliving26
#SBATCH --time=00:10:00
#SBATCH --requeue
#SBATCH --mem=64G

DATASET_PATH=${HOME}"/scratch/imagenet/"
EXPERIMENT_PATH=${HOME}"/scratch/sc_experiments/sc_800ep_cls_eval_superclass_nonliving26"
