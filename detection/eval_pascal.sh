...
#SBATCH --job-name=sc_800ep_pascal_eval
#SBATCH --time=0:20:00
#SBATCH --requeue
#SBATCH --mem=64G
...
EXPERIMENT_PATH=${HOME}"/scratch/sc_experiments/sc_800ep_pascal_eval"
MODEL_WEIGHTS=${HOME}"/scratch/sc_experiments/sc_800ep_pascal_train/model_final.pth"
